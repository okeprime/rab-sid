// public/js/kalkulator_material_renderer.js
// Kalkulator Material — fetch API version (data dari BQ + pricing)
...
async function loadSummaryData() {
  const data = await api('/api/calculator/material-summary');
  if (!data) return;
